  ...
  spawnClaudeStream({
    ...
    agentMeta: {
      ...
      sourceContext: {
        ...
        checkLink,
        checkName: checkName || '',
        url: meta.url || (baseOwner && baseRepo ? `https://github.com/${baseOwner}/${baseRepo}/pull/${meta.number}` : null),
        account: prReview.active.account || null,
  ...
  spawnClaudeStream({
    ...
    agentMeta: {
      ...
      sourceContext: {
        ...
        baseBranch,
        url: prReview.active.meta.url || (prReview.active.baseOwner && prReview.active.baseRepo ? `https://${prReview.active.host || 'github.com'}/${prReview.active.baseOwner}/${prReview.active.baseRepo}/pull/${prReview.active.meta.number}` : null),
        account: prReview.active.account || null,

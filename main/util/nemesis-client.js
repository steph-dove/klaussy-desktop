// Nemesis8 event-source client: models the agent lifecycle stream the
// notification gateway subscribes to. Embedded by default (instances.js calls
// publish()); connect() attaches to a real SSE endpoint if one is configured.

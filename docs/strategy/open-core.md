...
**klaussy-agents → keep MIT.** It's already MIT and published on PyPI, and we are sole copyright holder (Stephanie Dover, no external contributors). Tightening it would be the wrong move — and the instinct to "protect the most important repo hardest" is exactly the trap:
